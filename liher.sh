#!/bin/bash
# =============================================================================
# liher.sh — Launcher LIHER (Gobernador)
#
# Lanza el CLI gobernador (Agent SDK, multi-agent orchestration).
# Instala dependencias automaticamente si es la primera vez.
#
# Desde WSL2:     cd /mnt/d/Compartida/LIHER && bash liher.sh
# Desde Git Bash: cd /d/Compartida/LIHER && bash liher.sh
# =============================================================================
set -euo pipefail

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CLI_DIR="$ROOT/.sdd/cli"
CLI_ENTRY="$CLI_DIR/liher.mjs"
